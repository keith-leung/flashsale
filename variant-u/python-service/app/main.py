...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting Flash Sale Service (Variant U - Distributed Token Reserve)", extra={"service": "flash-sale-python-u"})
    yield
    # Shutdown
    logger.info("Shutting down Flash Sale Service", extra={"service": "flash-sale-python-u"})
