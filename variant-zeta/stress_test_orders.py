#!/usr/bin/env python3
"""Stress test Order API - 100 orders"""
...
async def main():
    """Run stress test"""
    print("=== Stress Test: 100 Orders ===")
    print(f"SKU: 2c2e23fa-f47b-4884-9b45-bf2a640f1ff3")
    print(f"Initial Stock: 10000")
    print()
    
    # Configure client with connection pooling
    limits = httpx.Limits(max_keepalive_connections=50, max_connections=100)
    async with httpx.AsyncClient(limits=limits, timeout=30.0) as client:
        # Run 100 orders concurrently
        start_time = time.time()
        tasks = [create_order(client, i) for i in range(1, 101)]
