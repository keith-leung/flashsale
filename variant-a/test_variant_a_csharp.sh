#!/bin/bash
# Variant A - C# Service Benchmark Script
...
SERVICE_PORT="30014"
HEALTH_ENDPOINT="http://${SERVICE_HOST}:${SERVICE_PORT}/health"
...
RESULTS_DIR="results"
RESULTS_CSV="${RESULTS_DIR}/variant_a_csharp.csv"
...
if [ "$HEALTH_CHECK" != "200" ]; then
    ...
    echo "Start with: docker-compose up -d csharp-service"
    exit 1
fi
